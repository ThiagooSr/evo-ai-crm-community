...
class Attachment < ApplicationRecord
  ...
  def message_id
    attachable_id if attachable_type == 'Message'
  end
  ...
  def should_validate_file?
    ...
    # We only enforce attachment type limits for website widget uploads.
    return false unless attachable_type == 'Message' && attachable.inbox.channel_type == 'Channel::WebWidget'

    true
  end

  def widget_data_url
    return file_url unless attachable_type == 'Message' && attachable.inbox.channel_type == 'Channel::WebWidget'
